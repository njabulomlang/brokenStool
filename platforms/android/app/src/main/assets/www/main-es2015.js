...
const routes = [
    ...
    { path: 'home', loadChildren: () => __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(m => m.HomePageModule) },
    {
        path: 'profile',
        loadChildren: () => __webpack_require__.e(/*! import() */ 21).then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/profile/profile.module.ts")).then(m => m.ProfilePageModule)
    },
    {
        path: 'basket',
        loadChildren: () => __webpack_require__.e(/*! import() */ 12).then(__webpack_require__.bind(null, /*! ./basket/basket.module */ "./src/app/basket/basket.module.ts")).then(m => m.BasketPageModule)
    },
    {
        path: 'payment/:docname',
        loadChildren: () => __webpack_require__.e(/*! import() */ 19).then(__webpack_require__.bind(null, /*! ./payment/payment.module */ "./src/app/payment/payment.module.ts")).then(m => m.PaymentPageModule)
    },
    {
        path: 'wishlist',
        loadChildren: () => __webpack_require__.e(/*! import() */ 27).then(__webpack_require__.bind(null, /*! ./wishlist/wishlist.module */ "./src/app/wishlist/wishlist.module.ts")).then(m => m.WishlistPageModule)
    },
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ./login/login.module */ "./src/app/login/login.module.ts")).then(m => m.LoginPageModule)
    },
    {
        path: 'sign-up',
        loadChildren: () => __webpack_require__.e(/*! import() */ 24).then(__webpack_require__.bind(null, /*! ./sign-up/sign-up.module */ "./src/app/sign-up/sign-up.module.ts")).then(m => m.SignUpPageModule)
    },
    {
        path: 'welcome',
        loadChildren: () => __webpack_require__.e(/*! import() */ 26).then(__webpack_require__.bind(null, /*! ./welcome/welcome.module */ "./src/app/welcome/welcome.module.ts")).then(m => m.WelcomePageModule)
    },
    {
        path: 'list/:key',
        loadChildren: () => __webpack_require__.e(/*! import() */ 17).then(__webpack_require__.bind(null, /*! ./list/list.module */ "./src/app/list/list.module.ts")).then(m => m.ListPageModule)
    },
    {
        path: 'categories/:data',
        loadChildren: () => __webpack_require__.e(/*! import() */ 13).then(__webpack_require__.bind(null, /*! ./categories/categories.module */ "./src/app/categories/categories.module.ts")).then(m => m.CategoriesPageModule)
    },
    {
        path: 'kwanga-apparel',
        loadChildren: () => __webpack_require__.e(/*! import() */ 16).then(__webpack_require__.bind(null, /*! ./kwanga-apparel/kwanga-apparel.module */ "./src/app/kwanga-apparel/kwanga-apparel.module.ts")).then(m => m.KwangaApparelPageModule)
    },
    ...
    {
        path: 'signup',
        loadChildren: () => __webpack_require__.e(/*! import() */ 25).then(__webpack_require__.bind(null, /*! ./signup/signup.module */ "./src/app/signup/signup.module.ts")).then(m => m.SignupPageModule)
    },
    {
        path: 'create-account',
        loadChildren: () => __webpack_require__.e(/*! import() */ 14).then(__webpack_require__.bind(null, /*! ./create-account/create-account.module */ "./src/app/create-account/create-account.module.ts")).then(m => m.CreateAccountPageModule)
    },
    /*  {
       path: 'cart-modal',
    ...
    {
        path: 'view/:view_id',
        loadChildren: () => __webpack_require__.e(/*! import() */ 10).then(__webpack_require__.bind(null, /*! ./view/view.module */ "./src/app/view/view.module.ts")).then(m => m.ViewPageModule)
    },
    {
        path: 'pending-orders',
        loadChildren: () => __webpack_require__.e(/*! import() */ 20).then(__webpack_require__.bind(null, /*! ./pending-orders/pending-orders.module */ "./src/app/pending-orders/pending-orders.module.ts")).then(m => m.PendingOrdersPageModule)
    },
    {
        path: 'order-history',
        loadChildren: () => __webpack_require__.e(/*! import() */ 18).then(__webpack_require__.bind(null, /*! ./order-history/order-history.module */ "./src/app/order-history/order-history.module.ts")).then(m => m.OrderHistoryPageModule)
    },
    {
        path: 'track-orders/:id',
        loadChildren: () => __webpack_require__.e(/*! import() */ 11).then(__webpack_require__.bind(null, /*! ./track-orders/track-orders.module */ "./src/app/track-orders/track-orders.module.ts")).then(m => m.TrackOrdersPageModule)
    },
    {
        path: 'receipts/:id',
        loadChildren: () => __webpack_require__.e(/*! import() */ 22).then(__webpack_require__.bind(null, /*! ./receipts/receipts.module */ "./src/app/receipts/receipts.module.ts")).then(m => m.ReceiptsPageModule)
    },
    {
        path: 'search',
        loadChildren: () => __webpack_require__.e(/*! import() */ 23).then(__webpack_require__.bind(null, /*! ./search/search.module */ "./src/app/search/search.module.ts")).then(m => m.SearchPageModule)
    },
    {
        path: 'info',
        loadChildren: () => __webpack_require__.e(/*! import() */ 15).then(__webpack_require__.bind(null, /*! ./info/info.module */ "./src/app/info/info.module.ts")).then(m => m.InfoPageModule)
    },
];
...
let AppComponent = class AppComponent {
    ...
    constructor(platform, screenOrientation, splashScreen, statusBar, router) {
    ...
    checkUser() {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_6__["auth"]().onAuthStateChanged((res) => {
            if (res) {
...
let AuthService = class AuthService {
    ...
    registerUser(email, password) {
        firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(email, password).then((res) => {
            console.log("User details", res.user);
            this.uid = res.user.uid;
        });
    }
    loginUser(email, password) {
        firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().signInWithEmailAndPassword(email, password).then((res) => {
            console.log("User details", res.user);
    ...
    loginPhone() {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().signInWithPhoneNumber(phone, appVerifier).then((res) => {
    ...
    requestLogin(number, appVerifier) {
        ...
        // .then(()=> {
        return firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().signInWithPhoneNumber('+27' + number, appVerifier).then(confirmationResult => {
    ...
    register(email, password) {
        return firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().createUserWithEmailAndPassword(email, password).then(data => {
    ...
    passwordReset(emailAddress) {
        firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().sendPasswordResetEmail(emailAddress).then(() => {
            // Email sent.
    ...
    signOut() {
        return new Promise((resolve, reject) => {
            firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().signOut().then(() => {
                // Sign-out successful.
                resolve();
    ...
    getUserProfile(userId) {
        return firebase__WEBPACK_IMPORTED_MODULE_2__["firestore"]().collection("Users/").doc(userId).get().then((snapshot) => {
            // Edit
            let profile = snapshot.data();
            if (profile.hasProfilePic) {
                return firebase__WEBPACK_IMPORTED_MODULE_2__["storage"]().ref('userDisplayPic/' + userId).getDownloadURL().then(url => {
