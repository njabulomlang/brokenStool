...
let KwangaApparelPageRoutingModule = class KwangaApparelPageRoutingModule {
};
...
let KwangaApparelPageModule = class KwangaApparelPageModule {
};
...
let KwangaApparelPage = class KwangaApparelPage {
    constructor() { }
    ngOnInit() {
    }
};
