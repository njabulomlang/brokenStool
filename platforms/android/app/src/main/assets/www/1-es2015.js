...
let LoginPage = class LoginPage {
    constructor(router, alertController, authService, toastCtrl
    // public fb: Facebook
    ) {
        this.router = router;
    ...
    googleSignin() {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().signInWithRedirect(provider).then((result) => {
    ...
    loginAnon() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                return yield firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().signInAnonymously();
            }
            catch (err) {
