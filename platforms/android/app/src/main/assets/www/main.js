...
var routes = [
    ...
    {
        path: 'wishlist',
        loadChildren: function () { return __webpack_require__.e(/*! import() */ 28).then(__webpack_require__.bind(null, /*! ./wishlist/wishlist.module */ "./src/app/wishlist/wishlist.module.ts")).then(function (m) { return m.WishlistPageModule; }); }
    },
    {
        path: 'login',
    ...
    {
        path: 'sign-up',
        loadChildren: function () { return __webpack_require__.e(/*! import() */ 25).then(__webpack_require__.bind(null, /*! ./sign-up/sign-up.module */ "./src/app/sign-up/sign-up.module.ts")).then(function (m) { return m.SignUpPageModule; }); }
    },
    {
        path: 'welcome',
        loadChildren: function () { return __webpack_require__.e(/*! import() */ 27).then(__webpack_require__.bind(null, /*! ./welcome/welcome.module */ "./src/app/welcome/welcome.module.ts")).then(function (m) { return m.WelcomePageModule; }); }
    },
    {
        path: 'list/:key',
    ...
    {
        path: 'signup',
        loadChildren: function () { return __webpack_require__.e(/*! import() */ 26).then(__webpack_require__.bind(null, /*! ./signup/signup.module */ "./src/app/signup/signup.module.ts")).then(function (m) { return m.SignupPageModule; }); }
    },
    {
        path: 'create-account',
    ...
    {
        path: 'receipts/:id',
        loadChildren: function () { return __webpack_require__.e(/*! import() */ 23).then(__webpack_require__.bind(null, /*! ./receipts/receipts.module */ "./src/app/receipts/receipts.module.ts")).then(function (m) { return m.ReceiptsPageModule; }); }
    },
    {
        path: 'search',
        loadChildren: function () { return __webpack_require__.e(/*! import() */ 24).then(__webpack_require__.bind(null, /*! ./search/search.module */ "./src/app/search/search.module.ts")).then(function (m) { return m.SearchPageModule; }); }
    },
    {
        path: 'info',
