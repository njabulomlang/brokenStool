...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.googleSignin = function () {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().getRedirectResult().then(function (result) {
            if (!result.user) {
                // User not logged in, start login.
                firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().signInWithRedirect(provider);
            }
            else {
