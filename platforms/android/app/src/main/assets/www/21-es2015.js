...
let ProfilePage = class ProfilePage {
    constructor(authService, router, toastCtrl, loadingController, camera, actionSheetCtrl, navCtrl) {
    ...
    toastController() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let toast = yield this.toastCtrl.create({ message: 'Profile update', duration: 2000 });
    ...
    takePicture(sourcetype) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.camera.getPicture(options).then(res => {
